...
\begin{haiku}
    {\FH まよひ子のをの\ruby[g]{か}{が}太鼓\ruby[g]{て}{で}\ruby[g]{尋}{たずね}られ}\hfill{\FH 無名氏}
...
\begin{haiku}
    {\FH 春の日の\ruby[g]{威光}{いこう}をみする雪間哉}\hfill{\FH 重頼}
...
\begin{haiku}
    {\FH 枯芝ややゝ\ruby[g]{陽炎}{かげろふ}の一二寸}\hfill{\FH 芭蕉}
...
\begin{haiku}
    {\FH 愛あまる猫は傾婦の\ruby[g]{媚}{こび}を仮る}\hfill{\FH 才麿}
...
\begin{haiku}
    {\FH \ruby[g]{植木}{うえき}屋のおいて行たる胡蝶かな}\hfill{\FH 蓼太}
...
\begin{haiku}
    {\FH くりかへし麦の\ruby[g]{畝}{うね}ぬふ小蝶かな}\hfill{\FH 曾良}
...
\begin{haiku}
    {\FH 鶯の笠\ruby[g]{落}{おと}したる椿かな}\hfill{\FH 芭蕉}
...
\begin{haiku}
    {\FH \ruby[g]{闇}{くらき}より闇に入るや猫の恋}\hfill{\FH 一茶}
...
\begin{haiku}
    {\FH 茨\ruby[g]{垣}{かき}犬の上手に\ruby[g]{潜}{くぐ}りけり}\hfill{\FH 一茶}
...
\begin{haiku}
    {\FH \ruby[g]{踞}{うずく}\ruby[g]{ふ}{ば}て雲を\ruby[g]{伺}{うかが}ふ蛙かな}\hfill{\FH 千代女}
...
\begin{haiku}
    {\FH \ruby[g]{釋教}{しゃっきょう}の歌か寺井に鳴くかへる}\hfill{\FH 閑節}
...
\begin{haiku}
    {\FH 長く鳴く蛙の歌や文字\ruby[g]{余}{あま}り}\hfill{\FH 永治}
...
\begin{haiku}
    {\FH 大仏の鼻から出たる\ruby[g]{乙鳥}{つばめ}哉}\hfill{\FH 一茶}
...
\begin{haiku}
    {\FH \ruby[g]{柴門}{しばのと}や錠のかはりのかたつぶり}\hfill{\FH 一茶}
...
\begin{haiku}
    {\FH 日の影や眠れる蝶に\ruby[g]{透}{す}き通り}\hfill{\FH 闌更}
...
\begin{haiku}
    {\FH 取りつかぬ心で\ruby[g]{浮}{う}かむ蛙かな}\hfill{\FH 丈草}
...
\begin{haiku}
    {\FH 一めんの\ruby[g]{落花}{らっか}の水に蛙の眼}\hfill{\FH 風生}
...
\begin{haiku}
    {\FH 行春や\ruby[g]{逡}{しゆん}\ruby[g]{巡}{じゆん}として遅ざくら}\hfill{\FH 蕪村}
...
\begin{haiku}
    {\FH \ruby[g]{連翹}{れんぎょう}のまぶしき春の\ruby[g]{憂}{うれ}ひかな}\hfill{\FH 万太郎}
...
\begin{haiku}
    {\FH \ruby[g]{郭公}{ほととぎす}一声夏をさだめけり}\hfill{\FH 蓼太}
...
\begin{haiku}
    {\FH 三角のいとま\ruby[g]{蜥蜴}{とかげ}の顔の少し延ぶか}\hfill{\FH 虚子}
...
\begin{haiku}
    {\FH 朝風に毛を\ruby[g]{吹}{ふか}れ居る毛むし哉}\hfill{\FH 蕪村}
...
\begin{haiku}
    {\FH 稲妻につむりなでけり\ruby[g]{引蟇}{ひきがえる}}\hfill{\FH 一茶}
...
\begin{haiku}
    {\FH 蚊\ruby[g]{柱}{ばしら}に夢の浮橋かかるなり}\hfill{\FH 其角}
...
\begin{haiku}
    {\FH \ruby[g]{濤}{なみ}暑し石に\ruby[g]{怒}{いか}れるひびきあり}\hfill{\FH 暁台}
...
\begin{haiku}
    {\FH ゆふ立やよみがへりたる\ruby[g]{斃}{たおれ}馬}\hfill{\FH 几董}
...
\begin{haiku}
    {\FH \ruby[g]{雨蛙}{あまがえる}芭蕉にのりてそよぎけり}\hfill{\FH 其角}
...
\begin{haiku}
    {\FH 短夜や\ruby[g]{芦}{あし}間流るる蟹の\ruby[g]{泡}{あわ}}\hfill{\FH 蕪村}
...
\begin{haiku}
    {\FH 涼しさや\ruby[g]{行燈}{あん}どん消えて水の音}\hfill{\FH 子規}
...
\begin{haiku}
    {\FH 夕顔の花\ruby[g]{噛}{か}む猫や余所ごころ}\hfill{\FH 蕪村}
...
\begin{haiku}
    {\FH 秋の季の赤とんぼうに\ruby[g]{定}{さだ}まりぬ}\hfill{\FH 白雄}
...
\begin{haiku}
    {\FH \ruby[g]{艸}{くさ}の葉を遊びありけよ露の玉}\hfill{\FH 嵐雪}
...
\begin{haiku}
    {\FH 夢返せ烏の\ruby[g]{覚}{さま}す霧の月}\hfill{\FH 鬼貫}
...
\begin{haiku}
    {\FH \ruby[g]{三度}{みたび}啼て聞えずなりぬ鹿の声}\hfill{\FH 蕪村}
...
\begin{haiku}
    {\FH \ruby[g]{巌}{いわ}月に\ruby[g]{大坐}{おおま}する}\hfill{\FH 井泉水}
...
\begin{haiku}
    {\FH どっしりと尻を\ruby[g]{据}{す}えたる\ruby[g]{南瓜}{なんか}かな}\hfill{\FH 漱石}
...
\begin{haiku}
    {\FH 夕霧や馬の\ruby[g]{覚}{おぼえ}し橋の穴}\hfill{\FH 一茶}
...
\begin{haiku}
    {\FH 秋風の\ruby[g]{鑓戸}{やりど}の口やとがり声}\hfill{\FH 芭蕉}
...
\begin{haiku}
    {\FH つゝみかねて月とり落す\ruby[g]{霽}{しぐれ}かな }\hfill{\FH 杜国}
...
\begin{haiku}
    {\FH 何もかも知ってをるなり\ruby[g]{竈}{かまど}猫}\hfill{\FH 風生}
...
\begin{haiku}
    {\FH 寒の月白炎\ruby[g]{曳}{ひ}いて山をいづ}\hfill{\FH 蛇笏}
...
\begin{haiku}
    {\FH こがらしや岩に\ruby[g]{裂}{さ}け行く水の声}\hfill{\FH 蕪村}
...
\begin{haiku}
    {\FH 憂きことを\ruby[g]{海月}{くらげ}に語る\ruby[g]{海鼠}{なまこ}かな}\hfill{\FH 召波}
...
\begin{haiku}
    {\FH 流れ来て氷を\ruby[g]{砕}{くだ}く氷かな}\hfill{\FH 五明}
...
\begin{haiku}
    {\FH \ruby[g]{乳呑}{ちのみ}子の風よけに立かがし哉}\hfill{\FH 一茶}
...
\begin{haiku}
    {\FH 負ふた子に\ruby[g]{蕨}{わらび}をりては持せける}\hfill{\FH 暁台}
...
\begin{haiku}
    {\FH \ruby[g]{末}{すえ}の子や御墓参りの箒持}\hfill{\FH 一茶}
...
\begin{haiku}
    {\FH 梨の花月に\ruby[g]{書}{ふ}ミよむ女あり}\hfill{\FH 蕪村}
...
\begin{haiku}
    {\FH \ruby[g]{骸骨}{がいこつ}の上を\ruby[g]{装}{よそ}ふて花見かな}\hfill{\FH 鬼貫}
...
\begin{haiku}
    {\FH \ruby[g]{花衣}{はなごろも}ぬぐやまつはる紐{ひも}いろいろ}\hfill{\FH 久女}
...
\begin{haiku}
    {\FH 門を\ruby[g]{出}{いず}ればわれも行人秋のくれ}\hfill{\FH 蕪村}
...
\begin{haiku}
    {\FH 寒月や小石のさはる\ruby[g]{沓}{くつ}の底}\hfill{\FH 蕪村}
...
\begin{haiku}
    {\FH 一人来て一人を\ruby[g]{訪}{と}ふや秋のくれ}\hfill{\FH 蕪村}
...
\begin{haiku}
    {\FH 応々と言へど\ruby[g]{叩}{たた}くや雪の門}\hfill{\FH 去来}
...
\begin{haiku}
    {\FH \ruby[g]{炭}{すみ}の火や\ruby[g]{齢}{よわい}のへるもあの通り}\hfill{\FH 一茶}
...
\begin{haiku}
    {\FH \ruby[g]{居眠}{いねぶ}りて我にかくれん冬ごもり}\hfill{\FH 蕪村}
...
\begin{haiku}
    {\FH がつくりと抜け\ruby[g]{初}{そめ}る歯や秋の風}\hfill{\FH 杉風}
...
\begin{haiku}
    {\FH 家はみな杖に\ruby[g]{白髪}{しらが}の墓参り}\hfill{\FH 芭蕉}
...
\begin{haiku}
    {\FH \ruby[g]{目出度}{めでた}さも\ruby[g]{中}{ちう}\ruby[g]{位也}{くらい}おらが春}\hfill{\FH 一茶}
...
\begin{haiku}
    {\FH \ruby[g]{外}{と}にも出よ触るるばかりに春の月}\hfill{\FH 汀女}
...
\begin{haiku}
    {\FH 春雨や\ruby[g]{欠}{あくび}をうつる門の犬}\hfill{\FH 一茶}
...
\begin{haiku}
    {\FH 石も木も\ruby[g]{眼}{まなこ}に光る暑さかな}\hfill{\FH 去来}
...
\begin{haiku}
    {\FH \ruby[g]{鍬}{くわ}立てゝあたり人なき熱さ哉}\hfill{\FH 子規}
...
\begin{haiku}
    {\FH 牛に成る合点ぞ\ruby[g]{朝寐}{あさね}夕すゞみ}\hfill{\FH 支考}
...
\begin{haiku}
    {\FH ぼうふりも御経の\ruby[g]{拍子}{ひょうし}とりにけり}\hfill{\FH 一茶}
...
\begin{haiku}
    {\FH 秋来ぬと合点させたる\ruby[g]{嚔}{くしゃみ}かな}\hfill{\FH 蕪村}
...
\begin{haiku}
    {\FH 雁わやわやおれが噂を\ruby[g]{致}{いた}す哉}\hfill{\FH 一茶}
...
\begin{haiku}
    {\FH \ruby[g]{冷冷}{ひえびえ}と袖に入る日や秋の山}\hfill{\FH 一茶}
...
\begin{haiku}
    {\FH 黒犬を\ruby[g]{提灯}{ちょうちん}にする雪の道}\hfill{\FH 無名氏}
...
\begin{haiku}
    {\FH 膝の児の\ruby[g]{指}{ゆびさし}始梅の花}\hfill{\FH 一茶}
