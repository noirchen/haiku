...
\begin{haiku}
    {\FH 春の風草深くても\ruby{古郷}{こきょう}\ruby{也}{なり}}\hfill{\FH 一茶}
...
\begin{haiku}
    {\FH 門の木も\ruby{先}{まづ}つつがなし\ruby{夕涼}{ゆうすずみ}}\hfill{\FH 一茶}

    {\FK 门前树依然无恙，好纳晚凉。}
\end{haiku}

\begin{haiku}
    {\FH わが春やたどん一つにい\ruby{小菜}{こな}\ruby{一把}{いちわ}}\hfill{\FH 一茶}

    {\FK 一把小菜一块煤，此乃我春天。}
\end{haiku}

\begin{haiku}
    {\FH \ruby{一抱}{ひとかか}えあれど柳は柳かな}\hfill{\FH 千代女}

    {\FK 虽有一抱之粗，但柳树仍是柳树。}
\end{haiku}

\begin{haiku}
    {\FH 音\ruby{添}{そ}ふて雨にしづまる\ruby{碪}{きぬた}かな}\hfill{\FH 千代女}

    {\FK 秋夜里的捶衣板声，消失在雨声中。}
\end{haiku}

\begin{haiku}
    {\FH \ruby{百生}{ひゃくなり}や\ruby{蔓}{つる}\ruby{一筋}{ひとすじ}の心より}\hfill{\FH 千代女}
...
\begin{haiku}
    {\FH \ruby{枯蘆}{かれあし}の日に日に折れて流れけり}\hfill{\FH 闌更}

    {\FK 枯芦苇，日日折断随流去。}
\end{haiku}

\begin{haiku}
    {\FH 翡翠の影こんこんと\ruby{遡}{さかのぼ}り}\hfill{\FH 茅舎}
...
\begin{haiku}
    {\FH \ruby{朴散華}{ほおさんげ}\ruby{即}{すなわ}ちしれぬ\ruby{行方}{ゆくへ}かな}\hfill{\FH 茅舎}

    {\FK 朴树散花，不知去向。}
\end{haiku}

\begin{haiku}
    {\FH さびしさや\ruby{一尺}{いちしゃく}消えてゆく蛍}\hfill{\FH 北枝}

    {\FK 流萤断续光，一明一灭一尺间，寂寞何以堪。}
\end{haiku}

\begin{haiku}
    {\FH ちぎりきな\ruby{互}{かた}みに\ruby{渋}{しぶ}き柿二つ}\hfill{\FH 大江丸}
...
\begin{haiku}
    {\FH けふも\ruby{托鉢}{たくはつ}こゝもかしこも花ざかり}\hfill{\FH 山頭火}
...
\begin{haiku}
    {\FH 行く\ruby{我}{われ}もにほへ花野を来る一人}\hfill{\FH 言水}
...
\begin{haiku}
    {\FH 子に\ruby{飽}{あ}くと申す人には花もなし}\hfill{\FH 芭蕉}

    {\FK 有人不爱子，花不为伊开。}
\end{haiku}

\begin{haiku}
    {\FH 目には青葉山ほととぎす\ruby{初鰹}{はつがつお}}\hfill{\FH 素堂}
...
\begin{haiku}
    {\FH \ruby{十団子}{とおだご}も\ruby{小粒}{こつぶ}になりぬ秋の風}\hfill{\FH 許六}
